...
<html lang="es-ES">
    ...
    <body class="bg-success">
        <header>
            <nav class="navbar navbar-expand-md navbar-light bg-light">
                <div class="container-fluid">
                    <a class="navbar-brand text-success">Registrar usuario</a>
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link active text-success" href="index.php">Salir</a>
                        </li>
                    </ul>         
                </div>  
            </nav>
        ...
        <div class="col-6"><!--  establece tamaño de la caja de texto   -->
            <form class="col-10 mx-auto" method="POST" action="ProcesarRegistro.php">
            ...
            <div class="col-5">
                ...
                <div class="mt-4">
                    <button class="btn btn-outline-light" type="submit" aria-label="user" value="User">Registrar</button>
                </div>
            </form>
        </div>
